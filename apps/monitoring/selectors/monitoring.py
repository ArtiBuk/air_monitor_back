...
from apps.monitoring.sources import CITY_BACKGROUND_SOURCES, COLLECTION_ENABLED_SOURCES
...
def get_air_map_snapshot():
    ...
    city_queryset = Observation.objects.filter(source__in=CITY_BACKGROUND_SOURCES)
    ...
    return {
        "summary": {
            ...
            "sources": list(COLLECTION_ENABLED_SOURCES),
        },
        "bounds": {
...
def get_monitoring_overview():
    return {
        ...
        "automatic_collection": {
            ...
            "schedule_minute": 5,
            "enabled_sources": list(COLLECTION_ENABLED_SOURCES),
        },
    }
